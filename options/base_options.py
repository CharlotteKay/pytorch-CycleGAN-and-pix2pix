...
class BaseOptions():
    ...
    def initialize(self):
        ...
        self.parser.add_argument('--n_layers_D1', type=int, default=3, help='only used if which_model_netD==n_layers')
        self.parser.add_argument('--n_layers_D2', type=int, default=5, help='only used if which_model_netD==n_layers')
